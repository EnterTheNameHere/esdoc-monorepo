...
describe(fileNameToDescription(__filename, 'TestDescMarkdown:'), function () {
  ...
  describe('in self detail', function () {
    ...
    // FIXME: generated code has changed
    //    // code fence of html
    //    assert.includes(doc.find('pre:nth-child(2) code.language-html code.source-code.prettyprint'), null,
