...
// import { ArrayOptionItemSchema } from '../../../../../src/options/ArrayOptionItemSchema.js';
...
//     it('Throws error when default value is invalid', function () {
...
//       expect(wrapper.bind(wrapper, itemSchema)).to.throw(InvalidOptionsSchemaDefinitionError, ".defaultValue property has an invalid value! Default value for type 'array' must be an array.");
...
//         expect(wrapper.bind(wrapper, itemSchema)).to.throw(InvalidOptionsSchemaDefinitionError, "'.defaultValue array has invalid value in it! A");
