...
describe('test/_Misc/InvalidSyntax:', function () {
  it('is invalid', function () {
    ...
    assert(InvalidCodeLogger._logs[0].filePath.match(/test[\\|/]src[\\|/]integration-test[\\|/]src[\\|/]_Misc[\\|/]InvalidSyntaxCode.js/u));
    assert.deepEqual(InvalidCodeLogger._logs[0].log, [1, 2]);

    assert(InvalidCodeLogger._logs[1].filePath.match(/test[\\|/]src[\\|/]integration-test[\\|/]src[\\|/]_Misc[\\|/]InvalidSyntaxDoc.js/u));
