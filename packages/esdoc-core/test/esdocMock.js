...
export class MockESDocTestEnvironment {
    ...
    constructor() {
        ...
        const realESDocPath = path_package.resolve(__dirname, '../../esdoc/out/ESDoc.js');
        //console.log('realESDocPath', realESDocPath);
        const realESDocCLIPath = path_package.resolve(__dirname, '../../esdoc/out/ESDocCLI.js');
        //console.log('realESDocCLIPath', realESDocCLIPath);
        const realESDocPackageJSON = path_package.resolve(__dirname, '../../esdoc/package.json');
